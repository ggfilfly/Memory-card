...
questions_list.append(Question('Столица Эстонии', 'Таллин', 'Кишинёв', 'Женева', 'Вильнюс'))
questions_list.append(Question('Как переводится слово "repair"', 'чинить', 'собирать', 'выворачивать', 'красить'))
questions_list.append(Question('Какой самый большой остров в мире?', 'Гренландия', 'Новая Земля', 'Венеция', 'Шри-Ланка'))
app = QApplication([])
...
def click_OK():
    ...
    if btn_OK.text() == 'Ответить':
        check_answer() # dfhfhuhuuuhu uu u hu hпроверка ответа
    else:
